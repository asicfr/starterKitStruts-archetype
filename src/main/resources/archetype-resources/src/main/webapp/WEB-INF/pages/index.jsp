...
<head>
<meta charset="utf-8">
<title>Liste des entit&${symbol_pound}233;s g&${symbol_pound}233;r&${symbol_pound}233;es</title>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="${symbol_pound}">Liste des entit&${symbol_pound}233;s g&${symbol_pound}233;r&${symbol_pound}233;es</a>
        </div>
      </div>
    </div>
		...
		<ul>
		    <%
			    for (String entite : EntityManagerHelper.getEntityList()) {
			        out.println("<li><a href=${symbol_escape}"" + entite + "/search${symbol_escape}">" + entite + "</a></li>");
				}
		    %>
	    </ul>
